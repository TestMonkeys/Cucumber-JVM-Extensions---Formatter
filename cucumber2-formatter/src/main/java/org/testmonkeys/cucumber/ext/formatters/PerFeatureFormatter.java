...
import static org.testmonkeys.cucumber.ext.formatters.Nodes.*;
...
public class PerFeatureFormatter implements Formatter {
    ...
    private void handleTestCaseStarted(TestCaseStarted event) {
        ...
        if (currentFeature == null || !currentFeatureUri.equals(event.testCase.getUri())) {
            ...
            else if (backgroundMap != null) backgroundMap.clear();
        }
    ...
    private void handleTestStepStarted(TestStepStarted event) {
        ...
        if (event.testStep instanceof PickleStepTestStep) {
            ...
            if (currentBeforeStepHookList.containsKey(Before.toString())) {
                currentStepOrHookMap.put(Before.toString(), currentBeforeStepHookList.get(Before.toString()));
